import styles from "../Styles/landingcarousal.module.css";
                    ...
                    >
                      ...
                      <div className={styles.text_content} aria-hidden="true">
                        ...
                        >
                          ...
                          wish I’d discovered @bonsaiinc long ago - great
                          templated contract"
                        </div>
                        <div
                    ...
                    >
                      ...
                      <div className={styles.text_content} aria-hidden="true">
                        <div
                          ...
                          aria-hidden="true"
                        >
                          "@bonsaiinc is probably my all time favorite freelance
                ...
                >
                  <div className={styles.testimonial_holder}>
                    <div className={styles.testimonial_block}>
                      ...
                      <div className={styles.text_content}>
                        <div className={styles.text_size_huge}>
                          "Anyone doing #freelance work should use @bonsaiinc
                    ...
                    <div className={styles.testimonialblocklowerhomepage}>
                      ...
                      <div className={styles.text_content}>
                        <div className={styles.text_size_huge}>
                          "Wow, @bonsaiinc's contracts are completely wonderful.
